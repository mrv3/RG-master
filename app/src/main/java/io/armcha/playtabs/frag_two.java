...
public class frag_two extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myview = inflater.inflate(R.layout.frag_two, container, false);

        mWebView = (WebView) myview.findViewById(R.id.events_main_webview);

        swipeLayout = (SwipeRefreshLayout) myview.findViewById(R.id.events_swipe_container);
        ...
        swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mWebView.loadUrl("https://www.ramiiegraphy.com/events");
